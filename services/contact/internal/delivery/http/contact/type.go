...
type ShortContact struct {
	...
	// Электронная почта
	Email email.Email `json:"email" binding:"omitempty,max=250,email" maxLength:"250" example:"example@gmail.com" format:"email" swaggertype:"string"` // custom string, that requires to complete methods of MarshalJSON, UnmarshalJSON.
	// Пол
	Gender gender.Gender `json:"gender" example:"1" enums:"1,2" swaggertype:"integer"` // custom type
	// Возраст
